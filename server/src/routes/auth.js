...
router.get('/me', requireAuth, async (req, res) => {
  try {
    const user = await User.findById(req.user.id).select('firstName lastName role profilePicture mentorProfile manualAvailabilitySlots timeZone hasCompletedProfile')
