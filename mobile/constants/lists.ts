...
// Copied from client/src/constants/lists.js — kept in sync manually since the
// server's resume-parsing heuristic (server/src/routes/upload.js) reads that
// original file by exact relative path, so it can't be moved.
