...
const PageLayoutDashboard = ({ children, userName, userRole, userPhoto, onPhotoUpdate }) => {
  return (
    <div className="h-screen flex flex-col bg-[#f6f6f6] overflow-hidden">
      ...
      <div className="shrink-0 flex justify-end px-6 py-3 border-t border-slate-200 bg-[#f6f6f6]">
        <button className="inline-flex items-center gap-2 bg-[#003F55] hover:bg-[#00212C] text-white px-5 py-2.5 rounded-full font-semibold text-sm shadow transition-colors">
